package models
// AUTO-GENERATED Slick data model for table ArchiveTransactionReports
trait ArchiveTransactionReportsTable {
  ...
  /** Entity class storing rows of table ArchiveTransactionReports
  ...
  case class ArchiveTransactionReportsRow(id: Long, month: Option[Int] = None, year: Option[Int] = None, timeZone: Option[String] = None, difference: Option[String] = None, lineId: Option[Long] = None, accountType: Option[String] = None, checkInDate: Option[String] = None, checkInTime: Option[String] = None, checkOutDate: Option[String] = None, checkOutTime: Option[String] = None, pod: Option[String] = None, storeName: Option[String] = None, description: Option[String] = None, credit: Option[scala.math.BigDecimal] = None, debit: Option[scala.math.BigDecimal] = None, product: Option[String] = None, txcode: Option[String] = None, customers: Option[String] = None, account: Option[String] = None, storeDlb: Option[String] = None, storeSuburb: Option[String] = None, storeState: Option[String] = None, storePostcode: Option[String] = None, storeType: Option[String] = None, consignmentNumber: Option[String] = None, receiverName: Option[String] = None, senderSuburb: Option[String] = None, senderState: Option[String] = None, senderPostcode: Option[String] = None, destinationSuburb: Option[String] = None, destinationState: Option[String] = None, destinationPostcode: Option[String] = None, destinationCountry: Option[String] = None, totalWeightKg: Option[scala.math.BigDecimal] = None, parcelCount: Option[Int] = None, createdAt: java.sql.Timestamp, modifiedAt: java.sql.Timestamp, locationType: Option[String] = None, storeAddress: Option[String] = None, storeLatitude: Option[String] = None, storeLongitude: Option[String] = None, storeCountry: Option[String] = None, channel: Option[String] = None, storeUnwanted: Option[String] = None, courierCode: Option[String] = None, biLocationType: Option[String] = None, barcode: Option[String] = None)
  /** GetResult implicit for fetching ArchiveTransactionReportsRow objects using plain SQL queries */
  implicit def GetResultArchiveTransactionReportsRow(implicit e0: GR[Long], e1: GR[Option[Int]], e2: GR[Option[String]], e3: GR[Option[Long]], e4: GR[Option[scala.math.BigDecimal]], e5: GR[java.sql.Timestamp]): GR[ArchiveTransactionReportsRow] = GR{
    prs => import prs._
    ArchiveTransactionReportsRow(<<[Long], <<?[Int], <<?[Int], <<?[String], <<?[String], <<?[Long], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[scala.math.BigDecimal], <<?[scala.math.BigDecimal], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[scala.math.BigDecimal], <<?[Int], <<[java.sql.Timestamp], <<[java.sql.Timestamp], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String])
  }
  /** Table description of table archive_transaction_reports. Objects of this class serve as prototypes for rows in queries. */
  class ArchiveTransactionReports(_tableTag: Tag) extends profile.api.Table[ArchiveTransactionReportsRow](_tableTag, Some("reports"), "archive_transaction_reports") {
    def * = (id :: month :: year :: timeZone :: difference :: lineId :: accountType :: checkInDate :: checkInTime :: checkOutDate :: checkOutTime :: pod :: storeName :: description :: credit :: debit :: product :: txcode :: customers :: account :: storeDlb :: storeSuburb :: storeState :: storePostcode :: storeType :: consignmentNumber :: receiverName :: senderSuburb :: senderState :: senderPostcode :: destinationSuburb :: destinationState :: destinationPostcode :: destinationCountry :: totalWeightKg :: parcelCount :: createdAt :: modifiedAt :: locationType :: storeAddress :: storeLatitude :: storeLongitude :: storeCountry :: channel :: storeUnwanted :: courierCode :: biLocationType :: barcode :: HNil).mapTo[ArchiveTransactionReportsRow]
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id) :: month :: year :: timeZone :: difference :: lineId :: accountType :: checkInDate :: checkInTime :: checkOutDate :: checkOutTime :: pod :: storeName :: description :: credit :: debit :: product :: txcode :: customers :: account :: storeDlb :: storeSuburb :: storeState :: storePostcode :: storeType :: consignmentNumber :: receiverName :: senderSuburb :: senderState :: senderPostcode :: destinationSuburb :: destinationState :: destinationPostcode :: destinationCountry :: totalWeightKg :: parcelCount :: Rep.Some(createdAt) :: Rep.Some(modifiedAt) :: locationType :: storeAddress :: storeLatitude :: storeLongitude :: storeCountry :: channel :: storeUnwanted :: courierCode :: biLocationType :: barcode :: HNil).shaped.<>(r => ArchiveTransactionReportsRow(r(0).asInstanceOf[Option[Long]].get, r(1).asInstanceOf[Option[Int]], r(2).asInstanceOf[Option[Int]], r(3).asInstanceOf[Option[String]], r(4).asInstanceOf[Option[String]], r(5).asInstanceOf[Option[Long]], r(6).asInstanceOf[Option[String]], r(7).asInstanceOf[Option[String]], r(8).asInstanceOf[Option[String]], r(9).asInstanceOf[Option[String]], r(10).asInstanceOf[Option[String]], r(11).asInstanceOf[Option[String]], r(12).asInstanceOf[Option[String]], r(13).asInstanceOf[Option[String]], r(14).asInstanceOf[Option[scala.math.BigDecimal]], r(15).asInstanceOf[Option[scala.math.BigDecimal]], r(16).asInstanceOf[Option[String]], r(17).asInstanceOf[Option[String]], r(18).asInstanceOf[Option[String]], r(19).asInstanceOf[Option[String]], r(20).asInstanceOf[Option[String]], r(21).asInstanceOf[Option[String]], r(22).asInstanceOf[Option[String]], r(23).asInstanceOf[Option[String]], r(24).asInstanceOf[Option[String]], r(25).asInstanceOf[Option[String]], r(26).asInstanceOf[Option[String]], r(27).asInstanceOf[Option[String]], r(28).asInstanceOf[Option[String]], r(29).asInstanceOf[Option[String]], r(30).asInstanceOf[Option[String]], r(31).asInstanceOf[Option[String]], r(32).asInstanceOf[Option[String]], r(33).asInstanceOf[Option[String]], r(34).asInstanceOf[Option[scala.math.BigDecimal]], r(35).asInstanceOf[Option[Int]], r(36).asInstanceOf[Option[java.sql.Timestamp]].get, r(37).asInstanceOf[Option[java.sql.Timestamp]].get, r(38).asInstanceOf[Option[String]], r(39).asInstanceOf[Option[String]], r(40).asInstanceOf[Option[String]], r(41).asInstanceOf[Option[String]], r(42).asInstanceOf[Option[String]], r(43).asInstanceOf[Option[String]], r(44).asInstanceOf[Option[String]], r(45).asInstanceOf[Option[String]], r(46).asInstanceOf[Option[String]], r(47).asInstanceOf[Option[String]]), (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Collection-like TableQuery object for table ArchiveTransactionReports */
  lazy val ArchiveTransactionReports = new TableQuery(tag => new ArchiveTransactionReports(tag))
}
