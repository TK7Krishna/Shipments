package models
// AUTO-GENERATED Slick data model for table TransactionsReportData
trait TransactionsReportDataTable {
  ...
  /** Entity class storing rows of table TransactionsReportData
  ...
  /** Collection-like TableQuery object for table TransactionsReportData */
  lazy val TransactionsReportData = new TableQuery(tag => new TransactionsReportData(tag))
}
