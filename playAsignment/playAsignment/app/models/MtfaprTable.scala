package models
// AUTO-GENERATED Slick data model for table Mtfapr
trait MtfaprTable {
  ...
  /** Entity class storing rows of table Mtfapr
  ...
  case class MtfaprRow(storenumber: Option[String] = None, storename: Option[String] = None, hubbedstorecode: Option[String] = None, allwdls: Option[Int] = None, totalexclgst: Option[Double] = None, gst: Option[Double] = None, totalincgst: Option[Double] = None)
  /** GetResult implicit for fetching MtfaprRow objects using plain SQL queries */
  implicit def GetResultMtfaprRow(implicit e0: GR[Option[String]], e1: GR[Option[Int]], e2: GR[Option[Double]]): GR[MtfaprRow] = GR{
    prs => import prs._
    MtfaprRow.tupled((<<?[String], <<?[String], <<?[String], <<?[Int], <<?[Double], <<?[Double], <<?[Double]))
  }
  /** Table description of table mtfapr. Objects of this class serve as prototypes for rows in queries. */
  class Mtfapr(_tableTag: Tag) extends profile.api.Table[MtfaprRow](_tableTag, "mtfapr") {
    def * = (storenumber, storename, hubbedstorecode, allwdls, totalexclgst, gst, totalincgst) <> (MtfaprRow.tupled, MtfaprRow.unapply)
  ...
  /** Collection-like TableQuery object for table Mtfapr */
  lazy val Mtfapr = new TableQuery(tag => new Mtfapr(tag))
}
